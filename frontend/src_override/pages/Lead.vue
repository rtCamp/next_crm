<template>
  <LayoutHeader>
    ...
    <template v-if="!errorTitle" #right-header>
      ...
      />
      <AssignTo v-model="assignees.data" doctype="Lead" :docname="leadId" />
      <Dropdown
        v-if="doc"
        :options="statuses"
        placement="right"
...
const { doctypeMeta } = getMeta('Lead')
...
const title = computed(() => {
  let t = doctypeMeta['Lead']?.title_field || 'name'
